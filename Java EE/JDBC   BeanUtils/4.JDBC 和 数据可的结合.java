...
JDBC 控制事物语句
	...
	Connection.rollback(); rollback 回滚到 起初语句
	Connection.commit();   commit   回滚到指定位置 

mysql 账户表

create table account(
id int primary key auto_increment,
accountNamee varchar(20),
money double
);

转载
upadte account set money=money-1000 where accountName='张三';
upadte account set money=money+1000 where accountName='李四';
